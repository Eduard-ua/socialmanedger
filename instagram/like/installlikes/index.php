...
<div class="order _container">
		<div class="order__title">Instagram - Лайки на все опубликованные (старые) фото вашего аккаунта</div>
		...
		<div class="order__info info-order">
			...
			<div class="info-order__block">
				...
				<div class="info-order__info">
					...
					<div class="info-order__text">50 в час</div>
				</div>
			</div>
			<div class="info-order__block">
				...
				<div class="info-order__info">
					...
					<div class="info-order__text">До 12 часов</div>
				</div>
			</div>
			<div class="info-order__block">
				...
				<div class="info-order__info">
					...
					<div class="info-order__text">7 дней</div>
				</div>
			</div>
		</div>
	</div>	
