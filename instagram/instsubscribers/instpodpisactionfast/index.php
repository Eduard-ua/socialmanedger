<?php require('../../../lib/db.php');?>
 ...
 <head>
    ...
    <title>SMM | Накрутка подписчиков</title>
<body>
<?php require "../../../header/_header.html"; ?> 
<?php require "../../../socialmenu/socialmenu.html"; ?> 
<div class="order _container">
		<div class="order__title">Instagram - АКЦИЯ! Подписчики (без гарантии, много списаний)</div>
				...
				<div class="products-content__card card-products order-products">
					<div class="card-products__top">
						<div class="card-products__bg">
							...
							<div class="card-products__label order-products-label"><strong>Без гарантий</strong></div>
						</div>
					</div>
		...
		<div class="order__info info-order">
			...
			<div class="info-order__block">
				...
				<div class="info-order__info">
					...
					<div class="info-order__text">200-400 в час</div>
				</div>
			</div>
			<div class="info-order__block">
				...
				<div class="info-order__info">
					...
					<div class="info-order__text">До 6 часов</div>
				</div>
			</div>
			<div class="info-order__block">
				...
				<div class="info-order__info">
					...
					<div class="info-order__text">Нет</div>
				</div>
			</div>
		</div>
	</div>	
