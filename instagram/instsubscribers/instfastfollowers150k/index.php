...
<div class="order _container">
		<div class="order__title">Instagram - Подписчики (живые)</div>
				...
				<div class="products-content__card card-products order-products">
					<div class="card-products__top">
						<div class="card-products__bg">
							...
							<div class="card-products__label order-products-label"><strong>Живые</strong></div>
						</div>
					</div>
					<div class="card-products__down">
						<div class="card-products__price">Цена за 100 штук - 46 ₽</div>
					</div>
				</div>
			</div>
			<form action="#">
		...
		<div class="order__info info-order">
			...
			<div class="info-order__block">
				...
				<div class="info-order__info">
					...
					<div class="info-order__text">200-5000 в сутки</div>
				</div>
			</div>
			<div class="info-order__block">
				...
				<div class="info-order__info">
					...
					<div class="info-order__text">30-60 минут</div>
				</div>
			</div>
			<div class="info-order__block">
