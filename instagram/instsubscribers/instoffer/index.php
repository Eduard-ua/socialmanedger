...
<div class="order _container">
		<div class="order__title">Instagram - Подписчики (частично русские)</div>
				...
				<div class="products-content__card card-products order-products">
					<div class="card-products__top">
						<div class="card-products__bg">
							...
							<div class="card-products__label order-products-label"><strong>Медленная скорость</strong></div>
						</div>
					</div>
		...
		<div class="order__info info-order">
			...
			<div class="info-order__block">
				...
				<div class="info-order__info">
					...
					<div class="info-order__text">20-1000 в сутки</div>
				</div>
			</div>
			<div class="info-order__block">
				...
				<div class="info-order__info">
					...
					<div class="info-order__text">До 10 минут</div>
				</div>
			</div>
			<div class="info-order__block">
