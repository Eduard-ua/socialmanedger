...
<div class="order _container">
		<div class="order__title">Instagram - Подписчики (с гарантией)</div>
				...
				<div class="products-content__card card-products order-products">
					<div class="card-products__top">
						<div class="card-products__bg">
							...
							<div class="card-products__label order-products-label"><strong>С гарантией</strong></div>
						</div>
					</div>
					<div class="card-products__down">
						<div class="card-products__price">Цена за 100 штук - 38 ₽</div>
					</div>
				</div>
			</div>
			<form action="#">
		...
		<div class="order__info info-order">
			...
			<div class="info-order__block">
				...
				<div class="info-order__info">
					...
					<div class="info-order__text">До 3000 в сутки</div>
				</div>
			</div>
			<div class="info-order__block">
