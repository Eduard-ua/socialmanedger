...
<div class="order _container">
		<div class="order__title">
		    Instagram - Подписка на показы публикаций
		</div>
				...
				<div class="products-content__card card-products order-products">
					<div class="card-products__top">
						<div class="card-products__bg">
							...
							<div class="card-products__label order-products-label">
							    <strong>
							      На показы
							    </strong>
							</div>
					...
					<div class="card-products__down">
						<div class="card-products__price">Цена за 1000 штук - 10 ₽</div>
					</div>
				</div>
			</div>
			<form action="#">
				<div class="content-order__right">
					...
					<div class="content-order__inputs inputs-content">
					    <div class="inputs-content__block tochka">
							<input placeholder="Ссылка на аккаунт" autocomplete="off" type="text" name="form[]" data-error="Ошибка" data-value="" class="input">
						</div>
						<div class="inputs-content__block tochka">
							<input placeholder="Количество просмотров" autocomplete="off" type="text" name="form[]" data-error="Ошибка" data-value="" class="input ">
						</div>
						<div class="inputs-content__block tochka">
							<input placeholder="Количество публикаций" autocomplete="off" type="text" name="form[]" data-error="Ошибка" data-value="" class="input">
						</div>
						<div class="inputs-content__block">
                            <select class="input select size="1" placeholder="">
                                <option value disabled selected>Задержка перед стартом</option>
                                <option value="1">Без задержки</option>
		...
		<div class="order__info info-order">
			<div class="info-order__block">
				...
				<div class="info-order__info">
					...
					<div class="info-order__text">Весь мир</div>
				</div>
			</div>
			<div class="info-order__block">
